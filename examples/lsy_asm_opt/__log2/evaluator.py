...
candidate assembly program. This evaluator runs a command like::
  ...
  ./build/tsuperoptimizer evaluator /path/to/__log2.toml --rewrite=/abs/path/to/candidate.s --tc-json=/tmp/tc.json
...
LOGGER = logging.getLogger("examples.__log2.evaluator")
...
def _evaluate(program_path: str) -> EvaluationResult:
    ...
    toml_path = tsuper_root / "asm" / "final_benchmark" / "__log2" / "__log2.toml"
    ...
    BASELINE_PERF = 58.125  # 你的初始程序 perf 值
    # BASELINE_PERF = 4.777777777777778
